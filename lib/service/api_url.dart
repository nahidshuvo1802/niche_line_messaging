class ApiUrl {
  ...
  //"https://deer-fat-issn-beauty.trycloudflare.com";
  //"https://postal-accessory-bath-mounting.trycloudflare.com";
  ...
  static  String sendAgainOtp({required String email}) => "/api/v1/user/resend_verification_otp/$email";
